...
worker_log_path = os.path.join(os.path.dirname(os.path.dirname(__file__)) + '/logs/blockchain', 'celery.log')
beat_log_path = os.path.join(os.path.dirname(os.path.dirname(__file__)) + '/logs/blockchain', 'beat.log')
